...
class StockPicking(models.Model):
    ...
    #location_dest_id = fields.Many2one(compute="_compute_location_id")
    ...
    def _get_invoice_lines_for_invoice(self, from_picking_line=False):
        ...
        for move_id in self.move_ids_without_package:
            ...
            if move_id.sale_line_id:
                ...
                discount = move_id.sale_line_id.discount
    ...
    def _pre_action_done_hook(self):
        ...
        #
        # El codigo comentado funciona para crear la alerta pero dejan de aparecer
    ...
    #        location_id = False  # Inicializar
    #        location_dest_id = False # Inicializar
    ...
    def _create_invoices_from_pickings(self):
        ...
        for picking in pickings:
            try:
                ...
                picking.message_post(body=f"Error en facturacion automática: {str(e)}")
