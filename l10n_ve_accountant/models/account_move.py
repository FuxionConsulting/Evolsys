...
class AccountMove(models.Model):
    ...
    def button_add_credit_note(self):
        """
        Este método intercepta el clic del botón "Añadir Nota de Crédito"
        y abre el wizard de selección Parcial/Total.
        """
        self.ensure_one()
        
        # Abre el nuevo wizard de selección (Requerimiento 1)
        return {
            'name': _('Crear Nota de Crédito'),
            'type': 'ir.actions.act_window',
            'res_model': 'account.move.reverse.partial', 
            'view_mode': 'form',
            'target': 'new',
            'context': {
