...
class WizardAccountingReportsevolsysInvoice(models.TransientModel):
    ...
    def sale_book_fields(self):
        sale_fields = [
            ...
            {"name": "Tipo de Transaccion", "field": "transaction_type"},
            {
    ...
    def _resume_sale_book_fields(self, moves):
        return [
            ...
            {
                "name": "Ventas Internas Gravadas solo por Alícuota General",
                "format": "number",
    ...
    def _resume_purchase_book_fields(self, moves):
        return [
            ...
            {
                "name": "Compras Internas Gravadas solo por Alícuota General",
                "format": "number",
                "values": self._determinate_resume_books(moves, "general_aliquot"),
            },
            {
