...
class TxtWizard(models.TransientModel):
    ...
    def _retention_iva(self, retentions):
        ...
        for line in retentions.mapped("retention_line_ids"):
            line_data = {}
            line_data["RIF del agente de retencion"] = line.retention_id.company_id.partner_id.vat
            ...
            line_data["Número de comprobante de retencion"] = (
