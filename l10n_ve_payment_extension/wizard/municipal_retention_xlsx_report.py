...
class MunicipalRetentionXlsxReport(models.TransientModel):
    ...
    def _xlsx_file(self, table, nombre):
        ...
        worksheet2.write("C2", "RENDICIoN INFORMATIVA MENSUAL DEL AGENTE DE RETENCIoN", bold)
        if tax_authorities_record.tax_authorities_name:
            worksheet2.write("D4", tax_authorities_record.tax_authorities_name.upper(), bold)
        worksheet2.write("A8", "AGENTE DE RETENCIoN:", bold)
        ...
        worksheet2.write("A11", "MES Y AnO DECLARADO:", bold)
        ...
        worksheet2.write(
            "A" + str(col2 + 5),
            "Agente de retencion Responsable de la Declaracion ____________________________________",
            bold,
        )
        worksheet2.write(
