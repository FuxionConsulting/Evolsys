...
class MunicipalRetentionXlsx(models.AbstractModel):
    ...
    _description = "Generador XLS de Retenciones Municipales" # <-- ¡Descripción añadida aquí!
    ...
    def xlsx_file(self, tabla, nombre, retention_id):
        ...
        worksheet2.write(
            "C3",
            "o de indole similar y el Decreto A-05-01-2016   Art. 8 Reglamento de Retenciones sobre Retenciones Actividades Economicas",
            bold,
        )
        worksheet2.write(
            "C5",
        ...
        worksheet2.write("D7", "AGENTE DE RETENCION", bold)
        worksheet2.write("G7", "COMPROBANTE:", boldWithBorder)
        worksheet2.write("G8", retention.name, boldWithBorder)
        worksheet2.write_rich_string("A11", bold, "RAZON SOCIAL :", str(company.name))
        worksheet2.write_rich_string(
            "A12",
            bold,
            "NUMERO DE REGISTRO UNICO DE INFORMACION FISCAL: ",
        ...
        worksheet2.write_rich_string("A13", bold, "DIRECCION FISCAL: ", company.street)
        worksheet2.write("G14", "FECHA DE EMISION O TRANSACCION", boldWithBorderJustify)
        worksheet2.write(
        ...
        worksheet2.write_rich_string("A16", bold, "RAZON SOCIAL: ", str(retention.partner_id.name))
        worksheet2.write_rich_string(
            "A17",
            bold,
            "NUMERO DE REGISTRO UNICO DE INFORMACION FISCAL: ",
        ...
        worksheet2.write("G18", "Ano:", boldWithBorder)
        ...
        worksheet2.write_rich_string(
            "A18", bold, "DIRECCION FISCAL: ", str(retention.partner_id.street)
        )
        worksheet2.write("D22", "DATOS DE LA TRANSACCION", bold)
        ...
        worksheet2.write(
            "B" + str(col2 + 12), "\t\tFirma del Agente de Retencion", boldWithBorderTop
        )
    ...
    def get_xlsx_municipal_retention(self, retention_id):
        ...
        for index, retention_line in enumerate(retention.retention_line_ids):
            ...
            rows["Actividad Economica"] = retention_line.economic_activity_id.name
